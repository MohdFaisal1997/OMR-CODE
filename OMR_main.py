...
contours, hieratchy = cv2.findContours(imgCanny,cv2.RETR_EXTERNAL,cv2.CHAIN_APPROX_NONE)
cv2.drawContours(imgcontours,contours,-1,(0,255,0),10)

# FIND RECTANGLES
rectCon = utlis.rectCountous(contours)
biggestContour = utlis.getCornerPoint(rectCon[0])
#print(biggestContour.shape)
gradePoints = utlis.getCornerPoint(rectCon[1])
...
if biggestContour.size != 0 and gradePoints.size != 0:
    ...
    # FINDING INDEX VALUES OF THE MARKKING
    myIndex =[]
